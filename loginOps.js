...
module.exports.userLogin = function (req, res) {
  sql.connect(webconfig, function (err) {
    ...
    var request1 = new sql.Request();
    request1.query(
      "INSERT INTO tbl_EtkinlikOlustur(EtkinlikAdi,Lokasyon,BaslangıcTarih,BitisTarihi,BaslangicSaati,BitisSaati,WebSiteUrl,AciklamaBir,ResimYukle,OrganizatörAdi,Aciklamaİki,FacebookLink,TwitterLink,İnstagramLink,BiletAdi,BiletUcret,BiletAdet,EkBilgi,EtkinlikTipi,EtkinlikKonusu) VALUES('" +
...
module.exports.userOturumAc = function (req, res) {
  sql.connect(webconfig, function (err) {
    ...
    var request1 = new sql.Request();
    request1.query(
      "INSERT INTO tbl_Uye(KullanıcıAdi,Adi,Soyadi,Email,Sifre)  VALUES('" +
...
module.exports.userEtkinlikBilgileri = function (req, res) {
  ...
  sql.connect(webconfig, function (err) {
    if (err) console.log(err);
    var request1 = new sql.Request();
    request1.query('select * from tbl_EtkinlikOlustur,tbl_Uye WHERE tbl_EtkinlikOlustur.Etkinlikİd=tbl_Uye.Id ', function (err, verisonucu) {
      if (err) {
        console.log(err);
      }
      console.log(verisonucu.recordset);
